...
/*   Updated: 2025/02/25 17:56:38 by codespace        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	diamondTrapTests()
{
	...
	DiamondTrap	diamondtrap2(diamondtrap); // Copy constructor
	DiamondTrap	diamondtrap3 = diamondtrap; // Copy asignation operator
	...
	diamondtrap.beRepaired(10);
	/*--------------*/
	std::cout << "----------- DiamondTrap End -------------" << std::endl;
	std::cout << RESET << std::endl;
}
